...
import { SideNavButton, SideNav, SideNavController } from "components/dashboard/sidenav.jsx";
...
export default function DashboardLayout({ children }) {
  ...
  return (
    <>
      ...
      <main className={`pt-24 p-4 overflow-y-auto min-h-screen bg-gray-100 transition-all duration-300 ${
